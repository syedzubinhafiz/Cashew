...
class Shape37 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get budgetFksExclude =>
      columnsByName['budget_fks_exclude']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<bool> get isReimbursable =>
      columnsByName['is_reimbursable']! as i1.GeneratedColumn<bool>;
  i1.GeneratedColumn<double> get reimbursableAmount =>
      columnsByName['reimbursable_amount']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<double> get reimbursedAmount =>
      columnsByName['reimbursed_amount']! as i1.GeneratedColumn<double>;
}
...
class Shape38 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get walletFk =>
      columnsByName['wallet_fk']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get linkedWalletFk =>
      columnsByName['linked_wallet_fk']! as i1.GeneratedColumn<String>;
}
...
final class Schema48 extends i0.VersionedSchema {
  ...
  late final Shape25 categories = Shape25(
      ...
      alias: null);
  late final Shape38 objectives = Shape38(
      source: i0.VersionedTable(
        entityName: 'objectives',
        withoutRowId: false,
        isStrict: false,
